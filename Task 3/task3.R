...
# Load the dataset
data <- read.csv("C:/Users/ZENBOOK/Desktop/R/Task 3/data_03cf4b0d-8941-4323-998c-a7ff1a83d0f2_1733812247131.csv")
...
plot(accepted_params[,1], accepted_params[,2], 
     col="green", pch=16, xlab=selected_params[1], ylab=selected_params[2],
...
hist(accepted_params[,1], col="pink", main=paste("Posterior of", selected_params[1]),
     xlab=selected_params[1], freq=FALSE)
hist(accepted_params[,2], col="blue", main=paste("Posterior of", selected_params[2]),
